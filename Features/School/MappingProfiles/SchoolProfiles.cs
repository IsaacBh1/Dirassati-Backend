...
public class SchoolProfiles : Profile
{
    public SchoolProfiles()
    {
        ...
        CreateMap<Auth.Register.Dtos.SchoolDto, Data.Models.School>()
            .ForMember(dst => dst.PhoneNumbers, opt => opt.Ignore())
            .ForMember(dst => dst.Specializations, opt => opt.Ignore());
    }
